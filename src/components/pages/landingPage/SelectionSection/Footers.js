...
const Footers = () => {
    return (
        <div className='grid grid-cols-1'>
            ...
            <div>
                ...
                <footer className="bg-white rounded-lg shadow m-4 dark:bg-gray-800">
                    <div className="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
                        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a className="hover:underline">Anunzio™</a>. All Rights Reserved.
                        </span>
            ...
            <hr className="w-full h-1 mx-auto my-4 bg-gray-400 border-0 rounded md:my-10" />
            ...
            <div>
                ...
                <footer className="bg-white rounded-lg shadow dark:bg-gray-900 m-4">
                    <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                        ...
                        <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a className="hover:underline">Anunzio™</a>. All Rights Reserved.</span>
                    </div>
                </footer>
